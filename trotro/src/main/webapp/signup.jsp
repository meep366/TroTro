    ...
    <div class="container">
      ...
      <form class="form-signin">
        ...
        <div class="btn-group" data-toggle="buttons-radio">
          <button type="button" class="btn">Driver</button>
          <button type="button" class="btn">Rider</button>
        </div>
        <br/>
        <br/>
        <a href="index.jsp"><button class="btn btn-large btn-primary" type="submit">Sign up</button></a>
      </form>
